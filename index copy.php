...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="foundationai-css/bootstrap.min.css">
    <!-- Custom stylesheet-->
    <link rel="stylesheet" href="foundationai-css/foundationai-css.css">
    <!-- Favicon-->
    <link rel="shortcut icon" href="foundationaisite-images/favicon.png">
